...
namespace SistemaVentas
{
    public partial class MDIPrincipal : Form
    {
        ...
        {
            sslUsuario.Text = "Desarrollado por: Brazaniii || " + "ID Usuario: "+ idUsuario + " || Usuario: " + nomUsuario;
            MessageBox.Show("Bienvenido: " + this.nomUsuario, "SIM", MessageBoxButtons.OK, MessageBoxIcon.Information);
